# Support for Output Descriptors in OPENBULLET Core

Since OPENBULLET Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `ammo1...` for mainnet or `tammo1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on OPENBULLET's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing OPENBULLET Core wallets, a convenience function `combo` is
