...
By default, OPENBULLET Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that openbullet's trustless model works best if you are
